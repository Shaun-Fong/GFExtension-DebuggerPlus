...
namespace DebuggerPlus.Runtime
{
    public sealed partial class DebuggerComponent : GameFrameworkComponent
    {
        ...
        private sealed class ConsoleWindow : IDebuggerWindow
        {
            ...
            private DebuggerPlus.Command.Command m_Command;
            private bool m_Reforce = false;
            ...
            public void OnDraw()
            {
                ...
                GUILayout.BeginHorizontal("box");
                {
                    ...
                    m_Command.Command_text = GUILayout.TextField(m_Command.Command_text);
                    ...
                    if (Event.current.type == EventType.KeyUp)
                    {
                        ...
                        {
                            m_Command.Command_text = Command.Command.History.Previous();
                        }
                        else if (Event.current.keyCode == KeyCode.DownArrow)
                        {
                            m_Command.Command_text = Command.Command.History.Next();
                        }
